...
const TICKER_ITEMS = [
  { label: 'Arabian Sea Swell', value: '1.4m · WSW · Slight Sea State', status: 'normal' },
  { label: 'Kerala Shelf SST', value: '28.6°C (Thermal front active)', status: 'normal' },
  { label: 'Live PFZ Candidates', value: '4 High-Yield Zones (INCOIS OISST/OC-CCI)', status: 'highlight' },
  { label: 'Monsoon Wind', value: '18.5 km/h · 245° WSW · 10.0 kn', status: 'normal' },
  { label: 'Indian EEZ Boundary', value: '200 NM Active · 0 Geofence Breaches', status: 'secure' },
  { label: 'Kochi Port Tide', value: '+1.1m High Tide at 16:24 IST', status: 'normal' },
  { label: 'GDACS Disaster Watch', value: 'No Active Cyclone Warnings in Arabian Sea', status: 'secure' },
  { label: 'Lightning Network', value: '0 Threat Clusters in 60 NM Corridor', status: 'normal' },
  { label: 'Fusion Frequency', value: 'Automated 60s Cycle Across 8 Agents', status: 'highlight' },
]
